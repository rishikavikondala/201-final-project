...
The visualization is represented as a bar graph, because the Bar graphs are useful when there are a high number of input groups such as the long list of neighborhood. The bar graph allows viewers to compare 
the number of reported crimes (y-axis) easily. 
The graph displays that Downtown Seattle has the highest rate of crime reported, Northgate and Capitol Hill has the higest rate following. 
The city with the lowest crime rate is Commercial Harbor Island. The numbers of crimes are proportionally distributed across the areas. 
